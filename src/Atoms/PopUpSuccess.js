                                        ...
                                        <div className="mx-auto col-12 col-sm-10 col-md-11 ">
                                            <div className="bg-white">
                                                <div className="four_zero_four_bg">
                                                    <h1 className="text-4xl md:text-5xl lg:text-6xl text-gray-800 font-bold">Thank You!</h1>
                                                </div>
                                                <h3 className="text-xl md:text-2xl font-semibold orange-clrsite mb-0 pt-1">
                                                    We have received your request, One of our Customer Care Executive will get back to you shortly.
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
