                    ...
                    {contextcur.currency === 'Asia/Kolkata' ? (
                        <div className="row">
                            <div className='col-xl-4 col-lg-6 col-12 mb-6'>
                                <div className="font-semibold text-xl mb-2 text-gray-900">Public Batches</div>
                            ...
                            <div className='col-xl-4 col-lg-6 col-12 mb-6'>
                                <div className="font-semibold text-xl mb-2 text-gray-900">Private Batches</div>
                                <div className="bg-white rounded-lg shadow-sm p-3 d-flex">
                                    <div className="media-left  w-10 text-left">
                                        <i className="shadow-md text-xs fas fa-phone-alt fa-2x text-blue-500"></i>
                                    </div>
                            ...
                            <div className='col-xl-4 col-lg-6 col-12 mb-6'>
                                <div className="font-semibold text-xl mb-2 text-gray-900">Corporate Batches</div>
