                        ...
                        <div className="scroll-spbx certification-courses">
                            <div className="container pt-24 pb-12  text-capitalize">
                                <div className="row">
                                    ...
                                    Que tenemos <span className='orange-clrsite d-inline-block'>Logrado hasta ahora</span></h2>
                                    ...
                                    <div className="col-xs-12 col-sm-6 col-lg-3">
                                        <ul className="counter_number px-0 mb-5">
                                            <li className="font-bold text-4xl md:text-5xl mb-1 text-blue-300">
                                                ...
                                                <AnimatedNumbers animateToNumber={parseInt(RegUser.RegisteredUsers)+100000}></AnimatedNumbers>
                                                </div>
                                            </li>
                                            <li className=" text-lg md:text-lg  font-semibold text-white tracking-wide">Usuarios Registrados</li>
                                        </ul>
                                    </div>
                                    <div className="col-xs-12 col-sm-6 col-lg-3">
                                        <ul className="counter_number px-0 mb-5">
                                            ...
                                            <li className=" text-lg md:text-lg  font-semibold text-white tracking-wide">Cursos Disponibles</li>
                                        </ul>
                                    </div>
                                    <div className="col-xs-12 col-sm-6 col-lg-3">
                                        <ul className="counter_number px-0 mb-5">
                                            ...
                                            <li className=" text-lg md:text-lg  font-semibold text-white tracking-wide">Próximas Clases</li>
                                        </ul>
                                    </div>
                                    <div className="col-xs-12 col-sm-6 col-lg-3">
                                        <ul className="counter_number px-0 mb-5">
                                            ...
                                            <li className=" text-lg md:text-lg  font-semibold text-white tracking-wide">aprendizaje electronico</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
