        ...
        <div className='mocktestregister-form becomeins-form'>
            ...
            {cntryLoad ?
                <div className='w-100 form-annum talwin-formstyle services-movingr bg-white'>
                    ...
                    <p className="text-3xl font-bold text-gray-700 mb-0 sitblu-clrsite">Inscribirse</p>
                    <div className="border-t-2 border-gray-300 w-14 mt-2 mb-2"></div>
                    <div className="pt-4">

                        <div className="row pb-2">
                            <div className="col-12">
                                <input type="text" placeholder="Nombre" className="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-3 pr-3 
         ...
         h-12 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 text-base">
                        ...
                        <div className="row">
                            <div className="col-lg-12 col-12">
                                <button aria-label="Inscribirse" className="h-12 btn-site w-100 mt-4 invert">
                                <span className='text-lg btn-widelettspc'>Inscribirse</span>
                                </button>
                            </div>
                        </div>
                    </div>
