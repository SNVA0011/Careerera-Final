                                ...
                                <div className="col-xl-4 col-md-6 col-12 mb-4 mb-xl-0">
                                    <div className="full-w shadow-customblg rounded-xl overflow-hidden position-relative">
                                        ...
                                        <div className="p-4 border-top bg-white">
                                            <Link to={'/es'+'/blog/' + final[0].url} className="text-lg py-1 flex-grow-1 font-bold no-underline mb-1 text-black  d-block stretched-link">
                                                {final[0].title}
                                            </Link>
                                            <div className="mt-3 d-flex flex-column flex-xl-row align-items-xl-center justify-content-between">
                                                ...
                                                <Link to={'/es'+'/blog/' + final[0].url} className="btn-site invert no-underline">
                            ...
                            final[1] ?
                                <div className="col-xl-4 col-md-6 col-12 mb-4 mb-xl-0">
                                    <div className="full-w shadow-customblg rounded-xl overflow-hidden position-relative">
                                        ...
                                        />
                                        <div className="p-4 border-top bg-white">
                                            <Link to={'/es'+'/blog/' + final[1].url} className="text-lg py-1 flex-grow-1 font-bold no-underline mb-1 text-black  d-block stretched-link">
                                                {final[1].title}
                                            </Link>
                                            <div className="mt-3 d-flex flex-column flex-xl-row align-items-xl-center justify-content-between">
                                                ...
                                                <Link to={'/es'+'/blog/' + final[1].url} className="btn-site invert no-underline">
                                                    <span>Leer más</span></Link>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            final[2] ?
                                <div className="col-xl-4 col-md-6 col-12 mb-4 mb-xl-0">
                                    <div className="full-w shadow-customblg rounded-xl overflow-hidden position-relative">
                                        ...
                                        />
                                        <div className="p-4 border-top bg-white">
                                            <Link to={'/es'+'/blog/' + final[2].url} className="text-lg py-1 flex-grow-1 font-bold no-underline mb-1 text-black  d-block stretched-link">
                                                {final[2].title}
                                            </Link>
                                            <div className="mt-3 d-flex flex-column flex-xl-row align-items-xl-center justify-content-between">
                                                ...
                                                <Link to={'/es'+'/blog/' + final[2].url} className="btn-site invert no-underline">
                                                    <span>Leer más</span></Link>
                                            </div>
                                        </div>
                                    </div>
