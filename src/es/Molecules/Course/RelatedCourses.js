...
<nav className='container mb-2'>
    <ol className="breadcrumb wizard">
        <li className="breadcrumb-item font-semibold"><Link to="/es/" className='no-underline'>Casa</Link></li>
                                ...
                                <div className="cards bg-white">
                                    <div className="p-4 d-flex flex-column">
                                        ...
                                        <div className="text-right mt-3">
                                            <Link to={'/es/' + dates.courseFUllURL} className="no-underline btn-site">
                                                <span>Leer más</span>
                                            </Link>
                                        </div>
