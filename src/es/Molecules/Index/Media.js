                ...
                <div className="full-w media-prtslider ourmedia-bgblock">
                    <div className="container py-16">
                        ...
                        <div className="mb-1 text-center ">
                            <h4 className="text-3xl md:text-4xl lg:text-5xl  font-bold text-gray-700 mb-3 softwarelike">En Los <span className="text-blue-500 sitblu-clrsite">Medios</span></h4>
                        </div>
                        ...
                        <div className='text-center mt-0'>
                            <Link to="/es/in-media" className="btn-site invert no-underline">
                              <span>Ver todo</span>
                            </Link>
                        </div>
