                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-lg-7 col-12 pb-2 pt-1 text-right'>
                            ...
                            <Link to="/es/help" className="no-underline">
                                <span className="text-sm xl:text-xs font-semibold text-gray-600 capitalize">
