                                                            ...
                                                            <div className="cards h-100 d-flex flex-column">
                                                                <Link to={'/es/' + dat.courseFUllURL} className="no-underline mb-1">
                                                                    <div
                                                                        ...
                                                                        <img src={`${process.env.PUBLIC_URL}/upcoming_batches_icon/` + (dat.friendlyName) + ".png"}
                                                                ...
                                                                <Link to={'/es/' + dat.categoryURL} className="durationcou course-type mt-auto mb-0 p-0 no-underline text-gray-900 font-semibold">
