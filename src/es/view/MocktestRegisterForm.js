         ...
         h-12 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 text-base">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12 col-12">
                                                <button  aria-label="Registrarse" className="h-12 btn-site w-100 mt-4 invert">
                                                    <span className="text-lg btn-widelettspc">Registrarse</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <h2 className="form_text text-base font-semibold mt-3">
                                        ¿Ya tienes una cuenta? <Link to="/es/mocktest-login" className='no-underline'>Acceso</Link>
                                    </h2>
