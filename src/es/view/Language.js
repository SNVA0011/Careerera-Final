        ...
        <>
            {status ? <div className="certificatepost-grad">
                ...
                <Helmet>
                    ...
                    <link rel="canonical" href="https://www.careerera.com/es/language-program" />
                    ...
                    <div className="container py-20 megamenu-wrapper">
                        ...
                        <div className="row">
                            <div className="col-lg-10 col-xl-8 mx-auto col-12 text-center">
                                <h1 className="text-center text-gray-700 font-bold text-3xl md:text-4xl uppercase">Idioma <span className="text-blue-500 sitblu-clrsite d-inline-block">Programa</span></h1>
