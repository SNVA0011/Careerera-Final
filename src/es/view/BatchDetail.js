    ...
    <>
      ...
      {Load ?
        <div>
          ...
          <Hero title="Batch Details" detail="" batch={<><Link to="/es/" className="no-underline badge bg-info">Home</Link><span className="mx-2"> / </span> <Link to="/es/all-batches" className="no-underline badge bg-info">All Batches</Link> <span className="mx-2"> / </span> Batch Details</>} />
