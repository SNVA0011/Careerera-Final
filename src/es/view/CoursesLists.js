                    ...
                    <div className="container py-20 megamenu-wrapper">
                        ...
                        <div className="row">
                            <div className="col-lg-10 col-xl-8 mx-auto col-12 text-center">
                                <h1 className="text-center text-gray-700 font-bold text-3xl md:text-4xl uppercase">CURSOS <span className="text-blue-500 sitblu-clrsite d-inline-block">POPULARES</span></h1>
                                            ...
                                            <>
                                                <ScrollAnimation animateIn='fadeInUpscrl' animateOut='fadeInUpscrlout' delay={i * 80} animateOnce={true} className="col-lg-4 col-sm-6 col-12 mb-4" key={i}>
                                                    <div className="cards h-100 d-flex flex-column empf">
                                                        <Link to={'/es/' + items.courseFUllURL} className="no-underline mb-1">
                                                            <div
                                                                ...
                                                                <img src={`${process.env.PUBLIC_URL}/upcoming_batches_icon/` + (items.categoryURL) + ".png"}
                                                        ...
                                                        <Link to={'/es/' + items.categoryURL} className="durationcou course-type mt-auto mb-0 p-0 no-underline text-gray-900 font-semibold">
