    ...
    return (
        <>
            ...
            <Hero
                ...
                detail=""
                batch={<><Link to="/es/" className="no-underline badge bg-info">Hogar</Link><span className="mx-2"> / </span>Trabajos</>} />
                                    ...
                                    return (
                                        <div className="d-flex w-100 media flex-column flex-sm-row" key={i}>
                                            ...
                                            <div className="flex-grow-1 media-body">
                                                <Link to={'/es/jobs/'+items.job_url + "/" + items.id} className="no-underline text-gray-700">
