...
import { esBlogList } from '../../Factory/PhpApi'
...
const Blog = () => {
    ...
    async function Bloglist() {
         await fetch(base, {
            method: 'POST',
            body: JSON.stringify({ "apiurl": esBlogList }),
            headers: {
                            ...
                            freeAllbatch[0][pagination_st]?.length > 0 ?
                                <>
                                    ...
                                    <Helmet>
                                        ...
                                        <meta name="description" content="This webpage Blog." />
                                        <meta name="keywords" content="Careerera Blog" />
                                        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
                                        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
                                        {pageblgid.id === undefined ?
                                            <link rel="canonical" href="https://www.careerera.com/es/blog"></link>
                                            :
                                            <link rel="canonical" href={"https://www.careerera.com/es/blog/page=" + (pageblgid.id)}></link>
                                        }
                                    </Helmet>
                                                    ...
                                                    <nav className="text-center">
                                                        <ul className="pagination justify-content-center blog_bxrowpagi flex-wrap mb-0">
                                                            ...
                                                            >
                                                                <Link
                                                                    className="page-link"
                                                                    to={'/es'+'/blog/page=' + (freeAllbatch[0]?.length)}
                                                                    onClick={() => {
                                                                        setPaginationst(
                                                                            freeAllbatch[0]?.length - 1
                                                                        );
                                                            ...
                                                            <li
                                                                ...
                                                                <Link
                                                                    className="page-link"
                                                                    to={'/es'+'/blog/page=' + (pagination_st + 2)}
                                                                    onClick={(e) => {
