...
<PopUp title="Post Graduate Program in Digital Marketing"/>
            ...
            <DescriptionStatic
                ...
                heading="Accelerate your career in DIGITAL MARKETING"
                ...
                data2={<><h4>Why choose Careerera for the PGP in Digital Marketing certification training?</h4>
            ...
            />
            <MWhy title="DIGITAL MARKETING" />
            <Completition
                title1={<>  <p><i className="fa fa-check-circle" aria-hidden="true"></i> Learn the latest approaches to strategic marketing that is effective across all channels</p>
                ...
                <div className="container py-16">
                    ...
                    < ProgramCarriculum
                        ...
                        detail1={<>  <li>Domain for SEO Standards</li>
                            ...
                            <span className="module_list_hding">Introduction for SEO</span>
                            <li>Introduction to SERP</li>
                            <li>Types of search engines</li>
                            <li>How search engines work</li>
                            <li>SEO Importance</li>
                            <span className="module_list_hding">Google algorithm and latest Updates</span>
                            ...
                            <span className="module_list_hding">On-Page Optimization</span>
                            ...
                            <span className="module_list_hding">Off-Page Optimization</span>
                            ...
                            <span className="module_list_hding">Local SEO:</span>
                            <li>Local Business Listing</li>
                            <li>Google places optimization</li>
                            <li>Improving Rankings</li>
                            <span className="module_list_hding">SEO Reports</span>
                    ...
                    < ProgramCarriculum
                        ...
                        detail1={<>
                            <span className="module_list_hding">Introduction - Success with AdWords Campaigns</span>
                            ...
                            <span className="module_list_hding">Landing Pages</span>
                            <li>Introduction for landing pages</li>
                            <li>Types of Landing pages</li>
                            <li>Creating Niche targeted Landing Pages</li>
                            <span className="module_list_hding">Quality Score Defines Your Success</span>
                            ...
                            <span className="module_list_hding">AdWords billing Account and Campaign Structure</span>
                            ...
                            <span className="module_list_hding">AdWords Tools</span>
                            <li>Keyword Tool</li>
                            <li>IP Exclusion</li>
                            ...
                            <span className="module_list_hding">Settings in Google Search AdWords</span>
                            ...
                            <span className="module_list_hding">Settings for Google Ad Words Search Campaign</span>
                            <li>Language</li>
                            <li>Networks</li>
                            <li>Bidding and Budget</li>
                            <li>Ad Extensions</li>
                            <li>Advanced Settings</li>
                            <span className="module_list_hding">Keywords</span>
                            ...
                            <span className="module_list_hding">Google Ad Words Campaign Tracking</span>
                            ...
                            <span className="module_list_hding">Bid Management and Your Daily Budget</span>
                            ...
                            <span className="module_list_hding">Landing Pages–The Google Ad Words Extension</span>
                            ...
                            <span className="module_list_hding">Optimizing Your Ad Words Campaigns</span>
                            ...
                            <span className="module_list_hding">The Ad Words Interface</span>
                            <li>Networks</li>
                            <li>Ad Extensions</li>
                            <li>Dimensions</li>
                            <li>Which is the Metrics that you will need in Your Ad Words Interface?</li>
                            <li>Features in the Ad Words Interface</li>
                            <span className="module_list_hding">AdWords Editor</span>
                            <li>Introduction & Importance of AdWords editor</li>
                            <span className="module_list_hding">My Client Center (MCC) Account in Google Ad Words</span>
                    ...
                    < ProgramCarriculum
                        ...
                        detail1={<>
                            <span className="module_list_hding">Overview of Social Media Marketing</span>
                            <li>Introduction</li>
                            <li>Promotion Types</li>
                            <li>Importance of landing Page</li>
                            <li>Tools that you should use in Social Media Marketing</li>
                            <span className="module_list_hding">Facebook Marketing (B2B & B2C Promotions)</span>
                            ...
                            <span className="module_list_hding">LinkedIn Marketing (B2B Promotions)</span>
                            ...
                            <span className="module_list_hding">Twitter Marketing</span>
                    ...
                    < ProgramCarriculum
                        ...
                        detail1={<>
                            <ul>
                                <span className="module_list_hding">Why Use Email Marketing at All</span>
                                ...
                                <span className="module_list_hding">Types of Email Marketing</span>
                                <li>Opt-in email</li>
                                <li>Double-Opt in</li>
                                <li>Broadcast email</li>
                                <li>Auto Responder email</li>
                                <span className="module_list_hding">Setting up Email Campaigns</span>
                                ...
                                <span className="module_list_hding">Tips for Email Campaign</span>
                                <li>Spam Violates</li>
                    ...
                    <h4 className="mt-12 font-bold text-lg sm:text-xl ">Module 9  <span className="heading-border-line"></span></h4>
                    < ProgramCarriculum
                    ...
                    <h4 className="mt-12 font-bold text-lg sm:text-xl ">Module 10  <span className="heading-border-line"></span></h4>
                    < ProgramCarriculum
                        topic1="Mobile Marketing:"
                        detail1={<><span className="module_list_hding">Mobile app fundamentals</span>
                            <li>Introduction to mobile apps for business</li>
                            <li>Platforms Apps development</li>
                            <li>Types of Apps Stores</li>
                            <span className="module_list_hding">Launching App like Pro</span>
                            <li>Ways to launch App</li>
                            <li>Pros and Cons of App</li>
                            <span className="module_list_hding">Make Money from App</span>
                            <li>Free VS Paid installs</li>
                            <li>Making money from App</li>
                            <li>Strategies for Making money from App</li>
                            <span className="module_list_hding">APP Store Optimization</span>
                            <li>Introduction</li>
                            <li>Keyword Research</li>
                            <li>Competitive Analysis</li>
                            <span className="module_list_hding">Ways to promote and market your app</span>
                            <li>Increasing Positive app signals</li>
                            <li>Strategies for Reviews to rank higher</li>
                            <li>Improving Apps download regularly</li>
                            <span className="module_list_hding">Apps tools</span>
                            <li>App analysis tools</li>
                            <li>App keyword research tools</li></>}
                    />

                    <h4 className="mt-12 font-bold text-lg sm:text-xl ">Module 11  <span className="heading-border-line"></span></h4>
                    < ProgramCarriculum
                    ...
                    <h4 className="mt-12 font-bold text-lg sm:text-xl ">Module 12  <span className="heading-border-line"></span></h4>
                    < ProgramCarriculum
                        topic1="Content Marketing:"
                        detail1={<> <ul>
                            <span className="module_list_hding">The course consists of the following subjects:</span>
                            ...
                            <span className="module_list_hding">The above subjects will include the following topics:</span>
...
<h4 className="mt-12 font-bold text-lg sm:text-xl ">Module 14  <span className="heading-border-line"></span></h4>
        < ProgramCarriculum
            ...
            <Capstone
                ...
                data1="Measure and monitor customer satisfaction for digital marketing agencies by conducting customer surveys. Customers prefer instant gratification for money spent; provide them that in a practical way."
                title2="Google Search Engine Case Study Analysis"
                data2="Bringing a website to the top of the search results in the Google search engine. You will use various SEO and marketing strategies to improve the page rankings of your chosen website and analyze the caste study of its journey to the top. "
                title3="Return on Investment for Different Marketing Strategies"
                data3="Contact different companies and comprehend their budgets for various marketing approaches. Carry out thorough analysis of the returns that the company expect in various metrics such as Future Value, Net Present Value, and Internal Rate of Return."
                title4="Create and Design a Blog"
                data4="Develop a flair for writing and post as many blog posts as can be written creatively. Implement various digital marketing strategies on the blog and make it more attractive to visitors. Practice creating backlings and content design through the medium of the blog. "
                title5="Social Media Strategies for Online Shopping Carts "
                data5="Use your skills to create and develop a seamless digital marketing project which revolves around social media. Target customers who have built shopping carts but haven’t checked them out through social media remarketing strategies."
                title6="Analysis and Comparison of Traditional Marketing to Digital Marketing"
                data6="Analyze and compare traditional marketing strategies to the modern digital marketing strategies. Evaluate the returns that a company receives from various components of digital marketing – RoI, conversion ratio, feedback, audience interaction."
                title7="Targeted Marketing with Facebook Analytics"
                data7="Track viewers who have viewed ads on Facebook across all Facebook channels such as Facebook lite, Messenger, Desktop, Mobile app etc. with the help of Facebook analytics. Target users with advertisements at a completely granular level."
                title8="Carry out Promotional Activities Through Coupon Codes"
                data8="On the basis of coupon codes, obtain valuable data about customer behaviour and feed it into different AI-based e- commerce algorithms to predict customer behaviour with greater accuracy and improve customer loyalty."
                title9="Analyze Competitors in Digital Marketing"
                data9="Evaluate, imitate, and outperform a company’s competitors in the field of Digital Marketing. Explore the various tools which are available to analyze competitor operations and strategies such as Google Analytics, Facebook Analytics, SpyFu, SimilarWeb, SEMrush etc."
                title10="Utilize Visual Keyword Tools"
                data10="Collect and make use of a plethora of keyword analysis tools which have the capability to connect to search engine APIs, retrieve most of the data associated with organic searches, perform evaluation and analysis, and deliver the best results to the users."
            ...
            <Faq
                ...
                ans1="A : Post Graduate Program in Digital Marketing is a carefully designed learning path that has been created by some of the leading industry experts. The structure of the course curriculum has been set up in a way that even a complete beginner to Digital Marketing will be able to follow the course progression and understand all the course materials clearly. Our world-class instructors will ensure that you become a master of Digital Marketing by the time you complete the course."
...
A : Digital Marketing is the process of using the internet, mobile devices, social media, search engines, and other channels to connect with consumers. Many marketing experts consider digital marketing to be a completely new field which requires many novel ways of reaching customers and different ways of comprehending the behaviour of customers compared to traditional marketing.

Digital marketing pinpoints a precise segment of the customer base and seeks to interact with them in profitable ways. Digital Marketing is growing rapidly as a field and includes email ads, search result ads, and promoted tweets – whatever includes marketing along with customer feedback or a both-sides interaction in between the customer and the company. There are many types of digital marketing, or digital marketing channels, such as Website marketing, Pay-per-Click (PPC) advertising, Content marketing, Email marketing, Social Media marketing, Affiliate marketing, Video marketing, SMS messaging etc.

Digital marketing is extremely important in today’s world which runs almost completely on the digital platform. There are many different digital channels being released every few days and the businesses and organizations have to stay abreast of these developments or be caught up forever in playing catchup. So the tools and techniques of Digital Marketing are very important to introduce one’s product to the modern target demographic.

"
                ques7="Q7 : Is a Digital Marketer a good Career choice?"
                ans7="A : Digital Marketing is in huge demand in many industries, ranging from IT to Finance to Ecommerce to Manufacturing to Healthcare to Retail. It is the fastest growing job on Linkedin and is predicted to create 11.5 million jobs by 2026. This makes Digital Marketer a very lucrative career choice. Also, the number of people who actually possess the requisite skillsets to become a complete Digital Marketer is very little. Thus, there is a high demand of Digital Marketer but a low supply of qualified people. So Digital Marketers can demand as big a salary as they want and the companies will have to comply with their demands."
                ques8="Q8 : What are the skills required to start a job in the field of Digital Marketing?"
                ans8="A : A Digital Marketer should have the ability to analyze data and draw insights so that they can track customer behaviour using data. He should possess organization and project management skills because running multiple digital campaigns becomes very complex very quickly. He will also need to lead and direct internal and external teams to manage projects and deliverables. He should also possess advanced social media knowledge because Digital Marketers have to build engaging communities on social media."
                ques9="Q9 : Who is eligible for taking the PGP in Digital Marketing course from Careerera?"
                ans9="



                A : Companies who will seek to hire Digital marketers will look for the following degrees -

                12th pass from school.
                
                For fresh graduates or college students - A degree in B.Tech/M.Tech (Any Trade), IT, BCA, MCA preferred.
                
                There is no bar to becoming a Digital Marketer. Anyone with the enthusiasm and zeal for learning can enroll in this course. We teach all the modules from scratch.
                
            
             "
                ques10="Q10 : What are the tools and technologies used to teach this PGP in Digital Marketing course from Careerera? "
                ans10="A : Wyng, Woobox, Facebook’s Power Editor, Mailchimp, AdRoll, Canva are some of the tools and technologies used in this course."

                ques12="Q11 : What is the duration of this PGP in Digital Marketing course from Careerera?"
                ans12="A : What do you mean by digital marketing?, Understanding the process of Digital Marketing, Enlightening brand visibility, Niche targeted traffic concepts, Implementing strategies for lead generation, Registering domain and webhosting, Introduction to SEO, Introduction to SERP, How google algorithms work, Niche targeted keyword research, Tools for competitor analysis, Static and dynamic web optimization"
                ques13="Q12 : Which topics are covered in the course curriculum of the PGP in Digital Marketing course from Careerera?"
                ans13="A : Retail, Web and Social Media, Supply Chain, Entrepreneurship, E-commerce, Banking, Healthcare, Insurance, Finance and Accounts etc."
            ...
            "
                ques15="Q14 : Why should one choose Careerera?"
                ans15="
