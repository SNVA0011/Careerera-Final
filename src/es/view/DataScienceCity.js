      ...
      {load ? <div>
        ...
        {data[0] ?
          <Helmet>
            ...
            <link rel="canonical" href={"https://www.careerera.com/data-science/certification-course/" + citycourse.countrycourse + "/" + citycourse.statecourse + "/" + citycourse.citycourse} />
          </Helmet>
          : ''}
            ...
            <div className="row py-16 align-items-center">
              <div className="col-xxl-8 col-xl-7 col-lg-6 col-12 pb-3 pb-xl-0">
                ...
                <p className="text-base sm:text-lg md:text-xl text-white my-8 font-medium  tracking-wide">
                  ...
                  facts with this world-class Data Science course in {citycourse.citycourse}, and propel your Data science career to the next level.
                </p>
              </div>
          ...
          <div className='discription_sec scroll-spbx' id='Description'>
            <div className='container py-16'>
              ...
              <div className="blog-detials-single">
                                <div className="content st data-scinece-othercer" dangerouslySetInnerHTML={{ __html: data[0].city_desc }}>
                                </div>
                               </div> 
                                : ''}
