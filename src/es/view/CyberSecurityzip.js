...
export default function CyberSecurityZip() {
    const [conthide, setconthide] = useState(false);
    const cyberzip = useParams()
    ...
    return (
        ...
        <>
            ...
            <Helmet>
                <title>{"Cyber Security Course in " + cyberzip.cyberzip + " With Placement Assistance"}</title>
                <meta name="description" content={"Careerera is one of the leading providers of cyber Security course in " + cyberzip.cyberzip + ". Register yourself today and get hands-on experience in R, Python, Tableau & Machine Learning."} />
                <meta name="keyword" content={"cyber Security course " + cyberzip.cyberzip + ", cyber Security course" + cyberzip.cyberzip} />
                <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
                <meta http-equiv="X-UA-Compatible" content="IE=edge" />
                <link rel="canonical" href={"https://www.careerera.com/cyber-security/certification-course/" + cyberzip.cyberCoutry + "/" + cyberzip.cyberstate + "/" + cyberzip.cybercity + cyberzip.cyberzip} />
            ...
            <div className='dataccience-pagecat'>
                ...
                <CountryFooterCourse title="cyber-security" />
            </div>
