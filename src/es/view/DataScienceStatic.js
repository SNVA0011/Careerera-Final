...
export default function DataScienceStatic() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Data Science Certification Course and Training Program Online</title>
        <meta name="description" content="Learn Data Science courses online and enroll for Data Science certification at Careerera. It offers Data Science practice tests and classroom training to achieve your goals." />
        ...
        <link rel="canonical" href="https://www.careerera.com/es/data-science" />
          ...
          <div className="row py-16 align-items-center">
            <div className="col-xxl-8 col-xl-7 col-lg-6 col-12 pb-3 pb-xl-0">
              <h1 className="text-2xl sm:text-3xl xl:text-4xl font-bold text-white uppercase">
                Data Science <span className="orange-lgclr d-inline-block"> CERTIFICATION COURSE </span>
              </h1>
      ...
      <div className='dataccience-pagecat'>
                  ...
                  <ScrollAnimation className="col-xl-4 col-md-6 col-12 mb-4" animateIn='fadeInUpscrl' animateOut='fadeInUpscrlout' animateOnce={true}>
                    <div className="cards h-100 d-flex flex-column">
                      <div className="pt-2 pl-4 rounded-lg">
                        ...
                        <img src={certificate} className="w-28 relative top-4 border rounded-full" alt="certificate-program" />
                      </div>
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'post-graduate-program-in-data-science/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'post-graduate-program-in-data-science'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'data-science-professional-certification/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'data-science-professional-certification'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'post-graduate-program-in-business-analytics/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'post-graduate-program-in-business-analytics'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'dsap-data-science-analytics-professionals/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'dsap-data-science-analytics-professionals'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'data-science-with-python/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'data-science-with-python'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'machine-learning-with-python/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'machine-learning-with-python'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'deep-learning-certification-training/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'deep-learning-certification-training'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'time-series-forecasting/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'time-series-forecasting'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'natural-language-processing/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'natural-language-processing'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'data-base-management-system/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'data-base-management-system'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'introduction-of-python-for-iem-utemss/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'introduction-of-python-for-iem-utemss'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'data-visualization-in-python/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'data-visualization-in-python'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'masters-in-data-science-engineering/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'masters-in-data-science-engineering'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'masters-in-data-science-and-analytics/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'masters-in-data-science-and-analytics'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
                    ...
                    <div className="cards h-100 d-flex flex-column">
                      ...
                      <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                        ...
                        <div className="mt-auto">
                          <div className='row'>
                            <div className='col-lg-6 col-12'>
                              <Link to={'/es'+'/data-science/'+'dsf-data-science-fundamental/batch'} className='btn-site invert no-underline text-sm w-100'>
                                <span>
                                  Upcoming Batches
                                </span>
                              </Link>
                            ...
                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                              <Link to={'/es'+'/data-science/'+'dsf-data-science-fundamental'} className='btn-site no-underline text-sm w-100'>
                                <span>
                                  Learn More
                                  <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                </span>
        ...
        <div className='discription_sec'>
          <div className='container py-16'>
            <div className="sec_title">
              <h3 className='text-2xl md:text-3xl font-bold'>Data Science  <span className='orange-clrsite'>Training Course</span></h3>
              <hr className="w-20 hr mb-4 bg-blue-400 sepfoll-hr"></hr>
            </div>
        ...
        <div className='discription_sec'>
          <div className='container pb-16'>
            <div className="sec_title">
              <h3 className='text-2xl md:text-3xl font-bold'>Why Choose Careerera for Your  <span className='orange-clrsite'>Data Science Training?</span></h3>
              <hr className="w-20 hr mb-4 bg-blue-400 sepfoll-hr"></hr>
            </div>
        ...
        <div className='discription_sec'>
          <div className='container pb-16'>
            <div className="sec_title">
              <h3 className='text-2xl md:text-3xl font-bold'>Our Course Content Spread Across
                <span className='orange-clrsite'>Various Programs Provides Learners with</span></h3>
              <hr className="w-20 hr mb-4 bg-blue-400 sepfoll-hr"></hr>
            </div>
        ...
        <div className='why-datasciencesuf scroll-spbx bg-blue-50' id='why'>
          <div className='container py-16'>
            <div className="sec_title">
              <h3 className='text-2xl md:text-3xl font-bold'>Why  <span className='orange-clrsite'>Data Science?</span></h3>
        ...
        <div className='discription_sec'>
          <div className='container py-16'>
            <div className="sec_title">
              <h3 className='text-2xl md:text-3xl font-bold'>Make Careerera your  <span className='orange-clrsite'>Guiding Force</span></h3>
