...
export default function CyberSecurityCity() {
    ...
    async function CallData() {
        ...
        const state = cybercity.cyberCoutry.replace("-", "%20")
        const county = cybercity.cyberstate.replace("-", "%20")
    ...
    return (
        ...
        <>
            ...
            {load ? <div> <Helmet>
                <title>{"Cyber Security Course in " + cybercity.cybercity + " With Placement Assistance"}</title>
                <meta name="description" content={"Careerera is one of the leading providers of cyber Security course in " + cybercity.cybercity + ". Register yourself today and get hands-on experience in R, Python, Tableau & Machine Learning."} />
                <meta name="keyword" content={"cyber Security course " + cybercity.cybercity + ", cyber Security course" + cybercity.cybercity} />
                <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
                <meta http-equiv="X-UA-Compatible" content="IE=edge" />
                <link rel="canonical" href={"https://www.careerera.com/cyber-security/certification-course/" + cybercity.cyberCoutry + "/" + cybercity.cyberstate + "/" + cybercity.cybercity} />
                    ...
                    <div className="container">
                        <Navbar variant="dark" className="shadow-0">
                            <Nav className="me-auto">
                                ...
                                <Nav.Link href="#why">Por qué la ciberseguridad</Nav.Link>
                ...
                <div className='dataccience-pagecat'>
                    ...
                    <div className='discription_sec scroll-spbx' id='Description'>
                        <div className='container py-16'>
                            <div className="sec_title">
                                <h2 className='text-2xl md:text-3xl font-bold'>La seguridad cibernética <span className='orange-clrsite'>Curso por Internet</span></h2>
                            ...
                            <div className="des_content">
                                <p>La ciberseguridad no solo se ha convertido en un campo prominente en la era de la tecnología, sino que también ha
                                    ...
                                    tecnología e información. Las organizaciones deben estar preparadas y bien equipadas para
                                    defenderse de las amenazas del ciberespacio. Existe una necesidad inherente de que los tomadores de decisiones
                                    familiarizarse con los principios fundamentales y la mejor ciberseguridad
                                    prácticas para empoderar sus negocios y mecanismos de operación. ciudadanos de todo
                                    el mundo se enfrenta a la necesidad de estar facultado para proteger sus identidades en línea y
                                    ocupaciones. La ciberseguridad, por lo tanto, es un componente crítico urgente de la tecnología.
                                    edad.&nbsp;
                                    Careerera se está involucrando significativamente en la preparación de una nueva generación de seguridad cibernética
                                    líderes y expertos por un mundo más seguro. El curso de Ciberseguridad online ofrecido por
                                    Careerera le brinda una ventaja profesional a través de un contenido de cursos bien formulado
                                    abarcando una perspectiva profesional, técnica y política sobre los temas planteados
                                    por rápidos avances tecnológicos. Los participantes aprenderán sobre seguridad informática
                                    principios, como la protección y prevención de ciberataques. Esta diversa ciberseguridad
                                    el enfoque multidisciplinario de los programas del curso le proporcionará las habilidades necesarias
                                    para la fuerza de trabajo cibernética de hoy mediante la fusión de la informática y la aplicación.</p>
                                ...
                                <div className={"desc_after_click " + (conthide ? 'd-block' : 'd-none')}>
                                    ...
                                    <h3 className='font-semibold text-2xl mt-4 mb-2'>¿Qué se lleva de nuestros programas de cursos en línea de seguridad cibernética?</h3>
                                    <ul className='list-disc pl-6 text-base'>
                                    <li>Conocimiento profundo de la protección de datos, salvaguarda de redes informáticas y
                                            uso seguro de Internet y todos los aspectos de la protección de sistemas limpios e infectados.</li>
                                        <li>Comprender terminologías y conceptos críticos relacionados con el derecho cibernético,
                                            propiedad y delitos cibernéticos, marcas registradas y robo de dominios.</li>
                                        <li>Aprender adquisición forense, determinar tecnología informática, evidencia digital
                                            recolección e informes probatorios.</li>
                                        <li>Demostrar una comprensión profunda de los principios de seguridad de la información y
                                            problemas en redes y sistemas de software.</li>
                                        <li>Evaluar y gestionar los riesgos asociados con el desarrollo, adquisición y
                                            evolución de la infraestructura segura.</li>
                                        <li>Diseñar y desarrollar tecnologías de redes, software y sistemas distribuidos
                                            usando ideas de seguridad de la información.</li>
                                        <li>En redes y sistemas de software, evalúe las compensaciones con respecto a seguridad, política,
                                            consideraciones comerciales, económicas y de gestión.</li>
                                    </ul>
                                    <p></p>
                    ...
                    <div className='explore_Data_science scroll-spbx' id='explore'>
                        <div className='container py-16'>
                            <div className="sec_title">
                                <h2 className='text-2xl md:text-3xl font-bold'>Explora nuestro <span className='orange-clrsite'>Cursos de Seguridad Cibernética</span></h2>
                                <p className='text-gray-500 text-base md:text-lg fw-medium'>Vea qué beneficios puede obtener al unirse a este programa.</p>
                                <hr className="w-20 hr mb-4 bg-blue-400 sepfoll-hr"></hr>
                            </div>
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'post-graduate-program-in-cyber-security/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'post-graduate-program-in-cyber-security'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'cyber-security-professional/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'cyber-security-professional'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'certified-information-systems-security-professional-cissp/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'certified-information-systems-security-professional-cissp'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'cisa-certification-training/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'cisa-certification-training'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'cism-certification-training/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'cism-certification-training'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'masters-in-cyber-security/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'masters-in-cyber-security'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'checkpoint-certification-training/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'checkpoint-certification-training'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'trend-micro-certification-training/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'trend-micro-certification-training'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'implementing-the-nist-standards-using-cobit-5/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'implementing-the-nist-standards-using-cobit-5'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'cobit5-certification-training/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'cobit5-certification-training'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'cobit-5-implementation-certification-training/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'cobit-5-implementation-certification-training'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'cobit-5-assessor-for-security-certification-training/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'cobit-5-assessor-for-security-certification-training'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'cobit-5-assessor-certification-training/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'cobit-5-assessor-certification-training'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                            ...
                                            <div className="cards h-100 d-flex flex-column">
                                                ...
                                                <div className="px-3 pb-2 pt-6 d-flex flex-column flex-grow-1 overflow-hidden">
                                                    ...
                                                    <div className="mt-auto">
                                                        <div className='row'>
                                                            <div className='col-lg-6 col-12'>
                                                                <Link to={'/es'+'/cyber-security/'+'csf-cyber-security-fundamental/batch'} className='btn-site invert no-underline text-sm w-100'>
                                                                    <span>
                                                                        Upcoming Batches
                                                                    </span>
                                                                </Link>
                                                            ...
                                                            <div className='ml-auto col-lg-6 col-12 mt-1 mt-lg-0'>
                                                                <Link to={'/es'+'/cyber-security/'+'csf-cyber-security-fundamental'} className='btn-site no-underline text-sm w-100'>
                                                                    <span>
                                                                        Learn More
                                                                        <i className="fas fa-chevron-right ml-2 align-middle"></i>
                                                                    </span>
                                    ...
                                    <Accordion.Body>
                                        <ul className='list-disc text-base row'>
                                            <li className='col-xxl-3 col-lg-6 col-12'>
                                                <Link to={'/es'+'/cyber-security/'+"/" + "cyber-security/certification-course/india"}>
                                                    India
                                                </Link>
                                            </li>
                                            <li className='col-xxl-3 col-lg-6 col-12'>
                                                <Link to={'/es'+'/cyber-security/'+"/" + "cyber-security/certification-course/malaysia"}>
                                                    Malaysia
                                                </Link>
                                            </li>
                                            <li className='col-xxl-3 col-lg-6 col-12'>
                                                <Link to={'/es'+'/cyber-security/'+"/" + "cyber-security/certification-course/singapore"}>
                                                    Singapore
                                                </Link>
                                            </li>
                                            <li className='col-xxl-3 col-lg-6 col-12'>
                                                <Link to={'/es'+'/cyber-security/'+"/" + "cyber-security/certification-course/uae"}>
                                                    UAE
                                                </Link>
                                            </li>
                                            <li className='col-xxl-3 col-lg-6 col-12'>
                                                <Link to={'/es'+'/cyber-security/'+"/" + "cyber-security/certification-course/united-kingdom"}>
                                                    United Kingdom
                                                </Link>
                                            </li>
                                            <li className='col-xxl-3 col-lg-6 col-12'>
                                                <Link to={'/es'+'/cyber-security/'+"/" + "cyber-security/certification-course/canada"}>
                                                    Canada
                                                </Link>
                                            </li>
                                            <li className='col-xxl-3 col-lg-6 col-12'>
                                                <Link to={'/es'+'/cyber-security/'+"/" + "cyber-security/certification-course/new-zealand"}>
                                                    New Zealand
                                                </Link>
                                            </li>
                                        </ul>
                    ...
                    <ZipFooterCourse title="cyber-security" id={cybercity.cybercountry} id2={cybercity.cyberstate} id3={cybercity.cybercity} />
                </div></div> : <div></div>}
