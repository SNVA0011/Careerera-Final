...
export default function CyberSecurityStatic() {
    ...
    return (
        ...
        <>
            ...
            <Helmet>
                <title>Cyber Security Certification Course and Online Training - Careerera</title>
                <meta name="description" content="Enroll for online Cyber Security certification courses at Careerera. It offers Cyber Security practice tests and classroom training to achieve your goals." />
                <meta name="keywords" content="Cyber Security programs, Cyber Security courses online, Cyber Security certification, Cyber Security training, Cyber Security certification online,  Cyber Security training online, Cyber Security certification training" />
