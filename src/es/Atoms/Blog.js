                            ...
                            <div className="full-w shadow-customblg rounded-xl overflow-hidden bg-white position-relative">
                                ...
                                <div className="p-4 border-top">
                                    {props.targetblankbx ?
                                        ...
                                        :
                                        <Link to={'/es/'+props.redirect1} className="text-lg py-1 flex-grow-1 font-bold no-underline mb-1 text-black  d-block stretched-link">
                                            {props.title1}
                                        </Link>
                                    }
                                    <div className="mt-3 d-flex flex-column flex-xl-row align-items-xl-center justify-content-between">
                                        ...
                                        {props.targetblankbx ?
                                            ...
                                            :
                                            <Link to={'/es/'+props.redirect1} className="btn-site invert no-underline">
                            ...
                            <div className="full-w shadow-customblg rounded-xl overflow-hidden bg-white position-relative">
                                ...
                                <div className="p-4 border-top">
                                    {props.targetblankbx ?
                                        ...
                                        :
                                        <Link to={'/es/'+props.redirect2} className="text-lg py-1 flex-grow-1 font-bold no-underline mb-1 text-black  d-block stretched-link">
                                            {props.title2}
                                        </Link>
                                    }
                                    <div className="mt-3 d-flex flex-column flex-xl-row align-items-xl-center justify-content-between">
                                        ...
                                        {props.targetblankbx ?
                                            <a target={'_blank'} href={props.redirect2} className="btn-site invert no-underline">
                                                <span>Leer más</span></a>
                                            :
                                            <Link to={'/es/'+props.redirect2} className="btn-site invert no-underline">
                                                <span>Leer más</span></Link>
                                        }
                                    </div>
                                </div>
                            ...
                            <div className="full-w shadow-customblg rounded-xl overflow-hidden bg-white position-relative">
                                ...
                                <div className="p-4 border-top">
                                    {props.targetblankbx ?
                                        ...
                                        :
                                        <Link to={'/es/'+props.redirect3} className="text-lg py-1 flex-grow-1 font-bold no-underline mb-1 text-black  d-block stretched-link">
                                            {props.title3}
                                        </Link>
                                    }
                                    <div className="mt-3 d-flex flex-column flex-xl-row align-items-xl-center justify-content-between">
                                        ...
                                        {props.targetblankbx ?
                                            <a target={'_blank'} href={props.redirect3} className="btn-site invert no-underline">
                                                <span>Leer más</span></a>
                                            :
                                            <Link to={'/es/'+props.redirect3} className="btn-site invert no-underline">
                                                <span>Leer más</span></Link>
                                        }
                                    </div>
                                </div>
