        ...
        <>
            <div className="megamenu-wrapper mega">
                <div className="dropdown" onMouseEnter={(e) => setHidemenust(false)}
                    ...
                    <button  aria-label="Todos los cursos" className={"dropdown-toggle btn btn-success "+ (hidemenust ? 'closed' : 'open')}>
                                                                    ...
                                                                    <>
                                                                        ...
                                                                        <div className="no-underline col-xxl-4 col-md-6 col-12 mb-4" key={ei}>
                                                                            <div className="cards h-100 d-flex flex-column">
                                                                                ...
                                                                                <Link to={'/es/' + dat.courseFUllURL} className="no-underline mb-1" onClick={(e) => setHidemenust(true)} key={ei}>
                                                                                    <div
                                                            ...
                                                            {item.Course?.length > 6 ?
                                                                <div className="col-12 mt-2 text-center">
                                                                    {totalcourslice === item.category_title ?
                                                                        showallcour > 6 ?
                                                                            <button aria-label="Muestra menos" className="btn-site" onClick={(e) => loadlessFun(item.category_title, 6)}>
                                ...
                                <div className="container scroll-area px-scrollbox-12 d-flex align-items-center justify-content-center">
                                    <div className="row above">
                                        <div className="col-12">
                                            <h6 className='text-xl md:text-2xl font-bold text-gray-700 text-center py-8'>No Result !</h6>
                                        </div>
                                    </div>
                                </div>
                            :
