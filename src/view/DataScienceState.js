...
import { countyDetailCyber, countyDetaildata } from '../Factory/PhpApi';
            ...
            <div className="row py-16 align-items-center">
              <div className="col-xxl-8 col-xl-7 col-lg-6 col-12 pb-3 pb-xl-0">
                ...
                <h1 className="text-2xl sm:text-3xl xl:text-4xl font-bold text-white uppercase">
                  Data Science <span className="orange-lgclr d-inline"> CERTIFICATION COURSE IN {statecourse.statecourse.replace('-', ' ')}</span>
                </h1>
                ...
                <p className="text-base sm:text-lg md:text-xl text-white my-8 font-medium  tracking-wide">
                  ...
                  course in <span className='capitalize'>{statecourse.statecourse.replace('-', ' ') + ', ' + statecourse.countrycourse.replace('-', ' ')}</span>. Get into immersive training by industry experts with course programs curated conscientiously giving students exposure to
                  ...
                  facts with this world-class Data Science course in <span className='capitalize'>{statecourse.statecourse.replace('-', ' ') + ', ' + statecourse.countrycourse.replace('-', ' ')}</span>, and propel your Data science career to the next level.
            ...
            <div className='container py-16'> 
              <div className="sec_title">
                <h2 className="text-2xl md:text-3xl font-bold text-capitalize">
                  Careerera’s  <span className='orange-clrsite'>Data Science</span> Course In {statecourse.statecourse.replace('-', ' ')}
                </h2>
