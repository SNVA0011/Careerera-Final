                        ...
                        <div className="row py-16 align-items-center">
                            <div className="col-xxl-8 col-xl-7 col-lg-6 col-12 pb-3 pb-xl-0">
                                <h1 className="text-2xl sm:text-3xl xl:text-4xl font-bold text-white uppercase">
                                    Cyber Security <span className="orange-lgclr d-inline"> CERTIFICATION COURSE IN {cyberCoutry.cyberCoutry.replace('-', ' ')}</span>
                                </h1>
                    ...
                    <div className='discription_sec scroll-spbx' id='Description'>
                        <div className='container py-16'>
                            <div className="sec_title">
                                <h2 className='text-2xl md:text-3xl font-bold text-capitalize'>Careerera’s  <span className='orange-clrsite'>Cyber Security</span> Course In {cyberCoutry.cyberCoutry.replace('-', ' ')}</h2>
