    ...
    return (
        ...
        <>
            ...
            <Helmet>
                ...
                <link rel="canonical" href="https://www.careerera.com/cyber-security" />
            </Helmet>
                    ...
                    <div className="row py-16 align-items-center">
                        <div className="col-xxl-8 col-xl-7 col-lg-6 col-12 pb-3 pb-xl-0">
                            <h1 className="text-2xl sm:text-3xl xl:text-4xl font-bold text-white uppercase">
                                Cyber Security <span className="orange-lgclr d-inline"> CERTIFICATION COURSE </span>
                            </h1>
            ...
            <div className='dataccience-pagecat'>
                ...
                <UserformsApplication customizeheading='true'
                    ...
                    cantitleheading='We Have Users For Our Cyber Security Program From Following Companies' />
