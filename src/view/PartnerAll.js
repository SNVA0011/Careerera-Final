...
<link rel="canonical" href="https://www.careerera.com/our-partners.php"/>
                </Helmet>
                ...
                <div className="container py-20">
                    <div className="row">
                        ...
                        <div className="col-lg-10 col-xl-8 mx-auto col-12 text-center">
                            <h1 className="text-center text-gray-700 font-bold text-3xl md:text-4xl uppercase">Our <span className="text-blue-500 sitblu-clrsite">Partner</span></h1>
