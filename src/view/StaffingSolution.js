...
export default function StaffingSolution() {
    ...
    return (
        <div className='staffingsol'>
            <Helmet>
            <title>Careerera- Staffing Solution</title>
...
<link rel="canonical" href="https://www.careerera.com/staffing-solution"/>


            </Helmet>

            <Hero title="STAFFING SOLUTIONS" 
             batch={<> <Link to="/" className="no-underline badge bg-info">Home</Link>
        <span className="mx-2"> / </span>Staffing Solutions </>} 
             />
                ...
                <div className="container pt-24 pb-12">
                    <div className="sec_title">
                        <h2 className="text-2xl md:text-3xl font-bold text-center">
                            STAFFING  <span className="orange-clrsite">SOLUTION</span>
                        </h2>
                        <hr className="w-20 hr mb-4 bg-blue-400 sepfoll-hr mx-auto" />
                    </div>
                    <div className="des_content text-center md:text-lg font-semibold">
                        <p>We are a renowned brand in recruitment industry apart from education and corporate training. Throughout the years of experience and expertise, we have catered most of the major MNC’s and Indian leading companies, which makes us a trusted consultant in recruitment services.</p>
                        <p>We are a Noida based company with its international presence in U.S, U.K, Singapore and Malaysia. We have expertise in hiring majorly in all industries in middle and senior management hierarchy. We have more than 100 consultants working with us, which includes more than 1500 recruiters with us. We have always been generating revenue i.e. 70% from our existing clients which expresses our client satisfaction</p>
                    </div>
                </div>
