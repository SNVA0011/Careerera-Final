                ...
                {loadYou ?
                    ...
                    <div className="testimonials-areamock whatstu">
                        <div className="container py-16">
                            ...
                            <div className="row">
                                <div className="col-lg-10 col-xl-8 mx-auto col-12 text-center">
                                    <h3 className="text-center text-gray-700 font-bold text-3xl md:text-4xl uppercase">Comm<span className="text-blue-500 sitblu-clrsite">ents</span></h3>
                                    <p className="text-gray-500 text-base md:text-lg fw-medium">What Our Students Say</p>
