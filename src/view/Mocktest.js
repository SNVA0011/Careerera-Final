...
export default function Mocktest() {
    ...
    return (
        <div className='mocktest-page'>
            ...
            <Helmet>
                ...
                <link rel="canonical" href="https://www.careerera.com/mocktest" />
                                    ...
                                    <div className="row">
                                        <div className="text-center text-white pb-5 col-xl-3 col-sm-6 col-12 ">
                                            ...
                                            <h2 className="font-bold text-4xl md:text-5xl mb-1">
                                                ...
                                                {parseInt(RegUser.RegisteredUsers) + 100000}
                                                </div>
                                            </h2>
                                            <h3 className=" text-lg md:text-lg">Registered Users</h3>
                                        </div>
                                        ...
                                        <div className="text-center text-white pb-5 col-xl-3 col-sm-6 col-12">
                                            ...
                                            <h3 className="text-lg md:text-lg">Courses Available</h3>
                                        </div>

                                        <div className="text-center text-white pb-5 col-xl-3 col-sm-6 col-12">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-full mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 14v3m4-3v3m4-3v3M3 21h28M3 10h28M3 7l9-4 9 4M4 10h26v11H4V10z" />
                                            </svg>
                                            <h2 className="font-bold text-4xl md:text-5xl mb-1">
                                                <div className='animated_numberscenter w-100'>
                                                {1054}
                                            ...
                                            <h3 className="text-lg md:text-lg">Upcoming Classes</h3>
                                        </div>

                                        <div className="text-center text-white pb-5 col-xl-3 col-sm-6 col-12">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-full mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 13v-1m4 1v-3m4 3V8M8 21l4-4 4 4M3 4h28M4 4h26v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
                                            </svg>
                                            <h2 className="font-bold text-4xl md:text-5xl mb-1">
                                                <div className='animated_numberscenter w-100'>
                                                {47}
                                            ...
                                            <h3 className="text-lg md:text-lg">E-Learning</h3>
                                        </div>
 ...
 <Spinner animation="border" variant="secondary" role="status"><span className="visually-hidden">Loading...</span></Spinner>
                ...
                <div className='container py-16'>
                    <div className="sec_title">
                        <h1 className="text-2xl md:text-3xl font-bold text-center">
                            Mock Exam  <span className="orange-clrsite">Registration Process</span>
                        </h1>
                            ...
                            <li>
                                <div className="direction-r">
                                    <div className="flag-wrapper">
                                        ...
                                        <br></br>
                                        <span className="flag">Select a Certification </span>
                                        <span className="time-wrapper">
                                            <span className="time">View from the list of 15 plus certifications to select from</span>
                                        </span>
                                        <div className='desc'>
                                            Look for career enhancing opportunities from various online certifications in project management, IT space, finance and other core areas.
                                        </div>
                            ...
                            <li>
                                <div className="direction-l">
                                    <div className="flag-wrapper">
                                        ...
                                        <br></br>
                                        <span className="flag">Free Registration</span>
                                        <span className="time-wrapper">
                                            <span className="time">Register for free and start taking the mock exams today!</span>
                                        </span>
                                        <div className='desc'>
                                            Careerera is an ideal space to know it ALL &amp; test your exam preparation. The mock tests provide a glimpse of the actual examination questions.
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div className="direction-r">
                                    <div className="flag-wrapper">
                                        ...
                                        <br></br>
                                        <span className="flag">Take a Sample/Mock test</span>
                                        <span className="time-wrapper">
                                            <span className="time">Take a sneak peak at what you could expect in the actual exam</span>
                                        </span>
                                        <div className='desc'>
                                            It would be prudent to take as many exams as possible to boost confidence and to test your preliminary assessment levels. Each of the exams are vigilantly questioned to ensure the entire course material is covered.
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div className="direction-l">
                                    <div className="flag-wrapper">
                                        ...
                                        <br></br>
                                        <span className="flag">Instant Exam Result &amp; Feedback</span>
                                        <span className="time-wrapper">
                                            <span className="time">Get results in seconds via Pie Charts, Review test results and Test statistics.</span>
                                        </span>
                                        <div className='desc'>
                                            The performance draws your attention to areas of the syllabus that require more understanding helps you gauge your preparation status!
                                        </div>
                                    </div>
            ...
            <div className='application_process_sec full-w start-yourcareer'>
                <div className='container py-20'>
                    <div className="sec_title text-center">
                        <h2 className="text-2xl md:text-3xl font-bold">WHY  <span className="orange-clrsite">CAREERERA</span></h2>
                        <p className="text-gray-500 text-base md:text-lg fw-medium">Makes Exam Preparation Simpler</p>
                        <hr className="w-20 hr mb-4 bg-blue-400 sepfoll-hr mx-auto" />
                    </div>
                    ...
                    <div className="pt-4">
                        <div className="row pt-1 justify-content-center">
                            ...
                            <div className="justify-items-center  col-lg-4 col-md-6 col-12 text-center py-4 rounded-lg mb-4">
                                ...
                                <div className="full-w">
                                    <h4 className='text-gray-700 font-bold text-lg mb-2'>All-in-One</h4>
                                    <p>Seek all the information about certifications just a click away</p>
                                </div>
                            </div>
                            ...
                            <div className="justify-items-center  col-lg-4 col-md-6 col-12 text-center py-4 rounded-lg mb-4">
                                ...
                                <div className="full-w">
                                    <h4 className='text-gray-700 font-bold text-lg mb-2'>Expert Advice
                                    </h4>
                                    <p>Recommendations from industry experts &amp; practitioners on reading resources and Training Institutes</p>
                            ...
                            <div className="justify-items-center  col-lg-4 col-md-6 col-12 text-center py-4 rounded-lg mb-4">
                                ...
                                <div className="full-w">
                                    <h4 className='text-gray-700 font-bold text-lg mb-2'>Free Mock Tests
                                    </h4>
                                    <p>Attempt vigilantly questioned free mock tests and alleviate exam qualms if any</p>
                            ...
                            <div className="justify-items-center  col-lg-4 col-md-6 col-12 text-center py-4 rounded-lg mb-4">
                                ...
                                <div className="full-w">
                                    <h4 className='text-gray-700 font-bold text-lg mb-2'>Evaluation
                                    </h4>
                                    <p>Obtain instant feedback and gauge your exam prep levels using result review, peer performance statistics &amp; grade analysis</p>
                            ...
                            <div className="justify-items-center  col-lg-4 col-md-6 col-12 text-center py-4 rounded-lg mb-4">
                                ...
                                <div className="full-w">
                                    <h4 className='text-gray-700 font-bold text-lg mb-2'>Colloquium
                                    </h4>
                                    <p>Discuss with like minded people using our Forum – an Open source platform</p>
            ...
            <div className='mockexam-certi scroll-spbx' id='mockexamcerti'>
                <div className='container py-20'>
                    <div className="sec_title text-center">
                        <h2 className="text-2xl md:text-3xl font-bold">MOCK EXAM <span className="orange-clrsite">CERTIFICATIONS</span></h2>
