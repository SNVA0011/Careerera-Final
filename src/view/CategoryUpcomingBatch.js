                                        ...
                                        <section className="page_404 py-16">
                                            <div className="container text-center my-sm-3">
                                                <div className="contant_box_404">
                                                    ...
                                                    <p className='text-base md:text-lg mb-4 font-semibold'>Click the button below to go back to the Homepage.</p>
                                        ...
                                        {listcour.CourseBatchList.Elearning ?
                                            listcour.CourseBatchList.Elearning.length > 0 ?
                                                <div className="full-w">
                                                    <h3 className="font-semibold text-3xl mb-3">E-Learning</h3>
                                                    <div className="row">
                                                        {
                                        ...
                                        <div className="container">
                                            ...
                                            {listcour.CourseBatchList.LVC ?
                                                listcour.CourseBatchList.LVC.length > 0 ?
                                                    <div className="full-w">
                                                        <h3 className="font-semibold text-3xl mb-3">Live Online</h3>
                                                        <div className="row">
                                                            {
