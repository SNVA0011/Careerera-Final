          ...
          <div className="container py-16">
            <div className="full-w">
              ...
              <div className='flex-grow-1 pb-2'>
                <>{Detail[0].batchDetails[0].Date.split('-')[2] < Year ? <div><p className="text-3xl font-bold text-red-600 shadow-2xl ml-1 shadow-black"> Sorry this Batch is Expired</p></div> : <div>{mo + 1 > (monthNames.indexOf(Detail[0].batchDetails[0].Date.split('-')[1]) + 1) ? <p className="text-3xl font-bold text-red-600 shadow-2xl ml-1 shadow-black"> Sorry this Batch is Expired</p> : <p></p>}</div>} </>
                <div className="d-flex flex-column flex-sm-row">
                  ...
                  <div className="flex-grow-1 pl-sm-4 courbt d-flex flex-column  mt-3 mt-sm-0">
                    ...
                    <div className="text-gray-500 font-medium mb-3">
                      ...
                      <span className="">
                        <i className="orange-lgclr bi bi-clock mr-1" /> {Detail[0].Batch[0].Totalhour} Hours
                      </span>
            ...
            <div className="full-w blog-detials-single">
              <div className="content normal mt-5">
                {Detail[0].Batch[0].TrainingAagenda ?
                  <>
                    <h3 className="text-xl font-semibold">Agenda of the Training:</h3>
                    <p className="text-gray-500 text-base mb-0 leading-relaxed" dangerouslySetInnerHTML={{ __html: Detail[0].Batch[0].TrainingAagenda }} />
                  </> : ''
                }

                {
                  Detail[0].Batch[0].TrainingOutcome ?
                    <>
                      <h3 className="text-xl mt-4 pt-2 font-semibold">Outcome of the Training:</h3>
                      <p className="text-gray-500 text-base mb-0 leading-relaxed" dangerouslySetInnerHTML={{ __html: Detail[0].Batch[0].TrainingOutcome }} />
                    </> : '' 
                }
                    ...
                    <Accordion.Item eventKey="0">
                      <Accordion.Header>
                        <div className='mr-3 mr-1 d-inline leading-normal'>
                          <span className="normal-case" dangerouslySetInnerHTML={{ __html: Detail[0].Batch[0].CourseTitel }}></span>, this Course and batch also available in other locations
                        </div>
