            ...
            <div className="full-w start-yourcareer relatedcr">
                ...
                <nav className='container mb-2'>
                    <ol className="breadcrumb wizard">
                        <li className="breadcrumb-item font-semibold"><Link to="/" className='no-underline'>Home</Link></li>
                        <li className="breadcrumb-item font-semibold"><a href="#all-categories" className='no-underline'>Career Path</a></li>
                        <li className="breadcrumb-item font-semibold active" aria-current="page">
                            <a className='no-underline'>Learning Path</a>
                        </li>
                    </ol>
                </nav>
                ...
                <div className="container py-16">
                    ...
                    <h1 className="font-bold text-2xl sm:text-3xl lg:text-4xl">LEARNING PATH</h1>
                                                                ...
                                                                {dates.CourseBatchList ?
                                                                    dates.CourseBatchList.Elearning.length > 0 || dates.CourseBatchList.LVC.length ?
                                                                        <Accordion.Item eventKey="0">
                                                                            <Accordion.Header>Upcoming Batches</Accordion.Header>
                                                                            <Accordion.Body>
