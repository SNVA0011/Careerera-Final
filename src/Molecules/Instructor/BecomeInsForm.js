                    ...
                    <div className="pt-4">
                        ...
                        <div className="row pb-2">
                            <div className="col-12">
                                <input type="text" placeholder="Name" className="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-3 pr-3 
