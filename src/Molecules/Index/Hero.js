        ...
        <div className="container py-16">
          <div className="row align-items-center">
            ...
            <div className="col-lg-7 col-xxl-8 col-12 mr-auto pl-0 mb-5 mb-lg-0">
              <span className="text-lg light text-white">Ready to learn <span className="heading-border-line"></span></span>
              <h1 className="text-5xl md:text-6xl xl:text-7xl text-white font-bold mb-4 maintitle">
                <small className="d-block highimp">High Impact Learning For</small>
                <span className="orange-clrsite">Advanced Career</span>
              </h1>
