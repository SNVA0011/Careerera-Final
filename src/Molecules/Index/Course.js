            ...
            <div className="full-w start-yourcareer ipsumsl">
              <div className="container py-16 megamenu-wrapper">
                <h3 className="text-center text-gray-700 font-bold mb-3 text-base sm:text-lg md:text-xl">
                  Start Your Career with <span className="orange-lgclr">{totaltitle?.length == 0 ? exactData[0].category_title : totaltitle[0]}</span>
                </h3>
                <p className="text-center text-gray-700 font-bold text-3xl md:text-4xl lg:text-5xl mb-4">
                  ...
                  + {' '} <span className="text-blue-500 sitblu-clrsite"> Professional </span> Courses
                </p>
                            ...
                            <Accordion.Body>
                              <div className="full-w">
                                <div className="d-block d-lg-none">
                                  ...
                                  <p className='titlewithbottomline mt-4'>POPULAR COURSES</p>
                                </div>
                    ...
                    <div className="container pt-12 sm:pt-20">
                      <div className="row">
                        <div className="text-center text-white pb-5 col-xl-3 col-sm-6 col-12 ">
                          ...
                          <p className=" text-lg md:text-lg">Registered User</p>
                        </div>
                        ...
                        <div className="text-center text-white pb-5 col-xl-3 col-sm-6 col-12">
                          ...
                          <p className="text-lg md:text-lg">Courses Available</p>
                        </div>
                        ...
                        <div className="text-center text-white pb-5 col-xl-3 col-sm-6 col-12">
                          ...
                          <p className="text-lg md:text-lg">Upcoming Classes</p>
                        </div>
                        ...
                        <div className="text-center text-white pb-5 col-xl-3 col-sm-6 col-12">
                          ...
                          <p className="text-lg md:text-lg">E-Learnings</p>
                        </div>
